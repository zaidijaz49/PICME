...
import Img1 from "../../assets/mission1.png"; // top right
import Img2 from "../../assets/mission2.png"; // middle left
import Img3 from "../../assets/mission3.png"; // middle right
import Img4 from "../../assets/mission4.png"; // bottom left
    ...
    <section className="bg-[#F7F7F7] py-20 px-6 md:px-16">
      <div className="max-w-7xl mx-auto space-y-20">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          {/* Text */}
          <div>
            <h2 className="text-3xl font-semibold mb-4 poppins-medium text-[32px]">
              Our Mission
            </h2>
            <p className="text-gray-600 leading-relaxed poppins-regular text-[16px]">
          ...
          {/* Image */}
          <div>
            <img src={Img1} alt="Mission" className="rounded-2xl " />
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center ">
          {/* Image */}
          <div>
            <img src={Img2} alt="Photographers" className="rounded-2xl" />
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          {/* Image */}
          <div>
            <img src={Img3} alt="Customer Experience" className="rounded-2xl" />
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center ">
          {/* Image */}
          <div>
            <img src={Img4} alt="Photographers" className="rounded-2xl" />
          </div>
