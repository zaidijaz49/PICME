  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center px-4 py-8">
      <div className="rounded-lg flex flex-col items-center justify-center px-6 sm:px-10 text-center w-full max-w-md shadow-2xl py-10">
        <div>
          <img src={Illustration} className="w-48 h-48 sm:w-64 sm:h-64 object-contain" alt="Illustration" />
        </div>

        {/* Title */}
        <h2 className="text-xl font-semibold mb-4 mt-4 poppins-semibold">Search Location</h2>
